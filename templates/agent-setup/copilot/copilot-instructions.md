...
Use the duckflow MCP tools for all annotation extraction, stitching, and Mermaid rendering work in this workspace.
...
- Use the `duckflow` skill when available to decide whether the task should use MCP extraction.
